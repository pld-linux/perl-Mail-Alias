...
Ten moduł pozwala na bezpośrednią manipulację danymi o aliasach e-mail,
zawartymi plikach o różnych formatach.  Podstawowym zastosowaniem modułu
jest manipulacja plikami w formacie Sendmaila.  Dodatkowo, możliwe jest
także korzystanie z kilku innych formatów oraz konwertowanie.
